...
/***/ function(module, exports, __webpack_require__) {
	...
	var Address = React.createClass({
		...
		onChange: function (e) {
			this.setState({ address: e.target.value }).bind(this);

			$.ajax({
				url: 'http://geocoder.ca/?locate=' + this.state.address + '&geoit=JSON',
				datatype: 'json',
				cache: false,
		...
		render: function () {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'label',
						{ className: 'control-label', 'for': 'address' },
						'Address'
					),
	...
	ReactDOM.render(React.createElement(Address, null), document.getElementById('order'));
