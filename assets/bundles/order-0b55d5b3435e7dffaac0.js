	...
	var Address = React.createClass({
		...
		render: function () {
			return React.createElement(
				'fieldset',
				{ 'class': 'form-group' },
				React.createElement('label', { 'for': 'address' }),
				React.createElement('input', { 'class': 'form-control', type: 'text' })
			);
		}
	});

	ReactDOM.render(React.createElement(Address, null), document.getElementById('container'));
